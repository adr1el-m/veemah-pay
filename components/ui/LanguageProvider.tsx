...
const translations: Translations = {
  ...
  'graph.expense_avg_30d': { en: 'Expense (30d avg)', tl: 'Gastusin (30-araw avg)' },
  'graph.expense_avg_90d': { en: 'Expense (90d avg)', tl: 'Gastusin (90-araw avg)' },
  'graph.expense_avg_ytd': { en: 'Expense (YTD avg)', tl: 'Gastusin (YTD avg)' },
